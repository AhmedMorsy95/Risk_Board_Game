...
// * @author smsm
// */
//public class PacifistVsAStar extends Player {
//
...
//    }
//
//    public Node go(Player Pacifist, int mapSz) throws CloneNotSupportedException {
//        Node cur = new Node(this, Pacifist, 0,1);
...
//                    // problem
//                    Player first = new PacifistVsAStar();
//                    first.c=cur.one.c;
...
//                    h++;
//
//                  ///attack (pacifist player)
//                    int sz = Integer.MAX_VALUE, attackFrom = -1, attackTo = -1;
...
//
//                    }
//                    if (sz < Integer.MAX_VALUE && cur.one.soldier_of_each_territory[attackTo] < cur.two.soldier_of_each_territory[attackFrom]) {
